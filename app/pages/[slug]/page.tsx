...
const page = async ({ params }: Props) => {
    ...
    const parsedContent = parse(page.content, options);
    if (!page)
    return (
     <NotFoundPage />
    )
            ...
            <main>
                <section>
                    <div className="container mx-auto px-5 md:px-0 w-full md:w-10/12 lg:w-5/12 font-work">
                        <Breadcrumb breadcrumbs={[{ text: "Sayfalar", url: "/" }, { text: page.title }]} align={"left"} />
                        ...
                        <div className="py-5">
                            ...
                            <div className="mt-3 md:mt-6 flex items-center gap-5 text-base-content/60">
                                ...
                                <p className="text-xs md:text-sm">{page.date.split("T")[0]}</p>
                            </div>
                        </div>
                     {page.featuredImage && 
                        <div className="mt-8">
